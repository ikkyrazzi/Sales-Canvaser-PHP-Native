<?php
// Start session and ensure user is an supervisor
session_start();
...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Supervisor Profile</h1>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    $profile_picture = !empty($user['photo']) ? '../uploads/' . htmlspecialchars($user['photo']) : '../uploads/supervisor/default.png';
                    ?>
